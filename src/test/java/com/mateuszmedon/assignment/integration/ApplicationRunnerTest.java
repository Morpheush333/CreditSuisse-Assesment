package com.mateuszmedon.assignment.integration;

import com.fasterxml.jackson.databind.ObjectMapper;

import com.mateuszmedon.assignment.AssignmentApplication;
...
public class ApplicationRunnerTest {
    ...
    private RequestMapper eventConverter;
    private AssignmentApplication applicationRunner;
    ...
    public void setup() {
        ...
        eventConverter = new RequestMapper();
    ...
    public void testRun__ProcessesLogFileAndSavesResultsToDatabase() throws IOException, SQLException {
        ...
        applicationRunner = new AssignmentApplication(objectMapper, connection, eventConverter);
